...
export const getClientsData =
   () =>
   async (dispatch: Dispatch<IClientsActions>): Promise<void> => {
      ...
      try {
         ...
         dispatch(
            fetchingClientsError('Problem z serverem. Nie można pobrać bazy danych z klientami.')
         );
...
export const addClient =
   ...
   async (
      ...
      try {
         ...
         dispatch(
            fetchingClientsError('Problem z serverem. Nie można dodać klienta do bazy danych')
         );
         throw new Error(JSON.stringify(err));
      }
   };
...
export const updateClient =
   ...
   async (
      ...
      try {
         ...
         dispatch(
            fetchingClientsError('Problem z serverem. Nie można zaktualizować danych klienta.')
         );
         throw new Error(JSON.stringify(err));
      }
   };
...
export const deleteClient =
   ...
   async (
      ...
      try {
         ...
         dispatch(
            openModal(MODAL_TYPES.SUCCESS, 'Klient został pomyślnie skasowany z bazy danych')
         );
      } catch (err) {
